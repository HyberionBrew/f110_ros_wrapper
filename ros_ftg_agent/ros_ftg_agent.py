...
def main(args=None):
    ...
    config_file_path = "/sim_ws/src/ros_ftg_agent/config/config_infsaal.json" #"/sim_ws/src/f1tenth_gym_ros/config2/config_fallstudien.json" #"/home/rindt/racecar_ws/src/f110_ros_wrapper/config/config.json"  # Update with the actual path
